        ...
        <section id="programs" className="bg-green-50 py-20 px-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-auto">
                    ...
                    {/* Card 1 — Specialized Classrooms (col 1, row-span-3 — navigates to /therapies) */}
                    <Link to="/therapies" className="md:row-span-3 block group">
                        <motion.div
                            custom={0}
                            ...
                            className="h-full bg-green-50 border border-green-200 rounded-3xl p-6 flex flex-col gap-4 shadow-sm cursor-pointer"
                        >
                            <div className="flex items-center justify-between">
                                ...
                                {/* Navigate hint badge */}
                                <span className="text-xs font-semibold font-sans text-teal-700 bg-teal-100 px-2.5 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                    View Details →
                                </span>
                            </div>
                            <div>
                    ...
                    {/* Card 2 — Skill Development (col 2, top — navigates to /student-life?category=skills) */}
                    <Link
                        to="/student-life?category=skills"
                        className="block w-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 rounded-2xl group"
                    >
                        <motion.div
                            custom={1}
                            variants={cardVariants}
                        ...
                        >
                            <div className="flex items-center justify-between">
                                ...
                                {/* Navigate hint badge */}
                                <span className="text-xs font-semibold font-sans text-orange-500 bg-orange-50 px-2.5 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                    View All →
                                </span>
                            </div>
                            <div>
                    ...
                    {/* Card 5 — Celebrating Traditions → /student-life?category=festivals */}
                    <Link
                        to="/student-life?category=festivals"
                        className="md:row-span-2 block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 rounded-3xl group"
                    >
                        <motion.div
                            custom={2}
                            variants={cardVariants}
                            ...
                            viewport={{ once: true }}
                            whileHover={hoverEffect}
                            className="h-full bg-teal-700 rounded-3xl p-6 flex flex-col gap-4 shadow-lg cursor-pointer"
                        >
                            <div className="flex items-center justify-between">
                                <div className="w-9 h-9 rounded-xl bg-white/20 flex items-center justify-center">
                                    <Flame size={18} className="text-orange-300" />
                                </div>
                                <span className="text-xs font-semibold font-sans text-white bg-white/20 px-2.5 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                    View All →
                                </span>
                            </div>
                            <div>
                            ...
                            <div className="flex items-center gap-1.5 text-white/80 text-sm font-semibold font-sans group-hover:gap-2.5 transition-all duration-200">
                    ...
                    {/* Card 3 — Project-Based Learning → /student-life?category=eco */}
                    <Link
                        to="/student-life?category=eco"
                        className="block w-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 rounded-3xl group"
                    >
                        <motion.div
                            custom={3}
                            variants={cardVariants}
                        ...
                        >
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-xs font-semibold font-sans text-teal-700 bg-teal-50 px-2.5 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                    View All →
                                </span>
                            </div>
                            <div>
                    ...
                    {/* Card 6 — State-Level Sports → /student-life?category=sports */}
                    <Link
                        to="/student-life?category=sports"
                        className="block w-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 rounded-3xl group"
                    >
                        <motion.div
                            custom={4}
                        ...
                        >
                            <div className="absolute top-4 right-4 w-12 h-12 rounded-full bg-orange-500 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-200">
                    ...
                    {/* Card 7 — Educational Excursions → /student-life?category=trips */}
                    <Link
                        to="/student-life?category=trips"
                        className="block w-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 rounded-3xl group"
                    >
                        <motion.div
                            custom={6}
                        ...
                        >
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-xs font-semibold font-sans text-yellow-600 bg-yellow-50 px-2.5 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                    View All →
                                </span>
                            </div>
                            <div>
